...
def sample_chain(target_wp_dict: dict, target_jackknife_inverse_dict: dict, target_ngal_dict: dict, paircounts: dict, param_set: Params, clustering_parameters: dict, other_stuff_dict_here: dict, nwalkers: int, num_steps: int, wp_limit=(0, 24)):
    ...
    #    1.42474565e+01, 1.48874045e+01, 9.64330200e-01, 1.96001803e-01, 5.42685958e-01]
            x0 = [1.27085074e+01, 1.38227680e+01, 1.92155405e-02, 1.42181471e+00,
                4.61818459e-01, 6.78968880e-01, 1.17626248e+01, 1.97535486e-02,
                1.70910430e-01, 1.55843645e+01, 4.80265886e-01, 5.92668381e+01,
                1.22488959e+01, 1.10676961e+01, 6.98361926e-01, 5.48566994e-01,
                6.28071063e-01]
