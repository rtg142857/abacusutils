...
def sample_chain(target_wp_dict: dict, target_jackknife_inverse_dict: dict, target_ngal_dict: dict, paircounts: dict, param_set: Params, clustering_parameters: dict, other_stuff_dict_here: dict, nwalkers: int, num_steps: int, wp_limit=(0, 24)):
    ...
    #    14.52401744, 15.83453532,  1.03107951,  0.11468305,  0.32196389]
        ...
        1.50005105e+01, 1.54727365e+01, 1.11966426e+00, 8.51818585e-01, 6.18101050e-02]#, 2.91416933e-01] best with fixed requirement on QSO ngal
    #         x0 = [1.28040375e+01, 1.38355218e+01, 2.14160156e-01, 1.41390494e+00,
    #    4.62499341e-01, 1.04378485e-01, 1.07735602e+01, 3.92243230e+00,
    #    2.58798840e+00, 1.17879465e+01, 1.66958562e-03, 7.06557816e+00,
    #    1.40980450e+01, 1.47790216e+01, 9.27436180e-01, 1.15037592e-01,
    #    8.00662853e-01] # best with no QSO pmax
    ...
    initial_guess_c2 = log_probability(np.array(x0), paircounts, param_set, target_wp_dict, target_jackknife_inverse_dict, target_ngal_dict, other_stuff_dict_here, clustering_parameters, minimum, wp_limit)
